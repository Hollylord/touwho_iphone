//
//  WDMyProgramTableViewController.m
//  ZBT
//
...
@interface WDMyProgramTableViewController ()
...
@implementation WDMyProgramTableViewController
...
- (void)loadNewData
{
   ...
   // [MBProgressHUD showMessage:@"正在加载" toView:self.view];
    ...
    params[@"method"] = @"myInvesteProject";
    ...
    [mgr GET:url parameters:params
     success:^(AFHTTPRequestOperation *operation, id responseObject) {
         ...
         for (NSDictionary *dict in jsonArr) {
             ...
             model.mFullImageUrl = [NSString stringWithFormat:@"%@%@",SERVER_URL,[dict objectForKey:@"mFullImageUrl"]];
