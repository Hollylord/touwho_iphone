...
- (void)addSpecifiedItem:(NSDictionary *)dic
{
    ...
    NSString *URLStr = dataDic[@"icon"];
    [dataDic setObject:@(UUMessageFromMe) forKey:@"from"];//UUMessageFromOther,UUMessageFromMe
...
- (void)addOtherSpecifiedItem:(NSDictionary *)dic
{
    ...
    NSString *URLStr = dataDic[@"icon"];
    [dataDic setObject:@(UUMessageFromOther) forKey:@"from"];//UUMessageFromOther,UUMessageFromMe
    [dataDic setObject:[[NSDate date] description] forKey:@"strTime"];
   // [dataDic setObject:@"Hello,Sister" forKey:@"strName"][@"icon"];
    [dataDic setObject:URLStr forKey:@"strIcon"];
